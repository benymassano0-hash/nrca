...
router.post('/transfer/init', authenticateToken, authorize('admin', 'registration_agent'), dogsController.transferDog);
router.get('/transfer/breeders', authenticateToken, authorize('admin', 'registration_agent'), dogsController.getAvailableBreeders);
